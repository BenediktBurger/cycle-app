...
void main() {
  testWidgets(
    'cycle chart keeps its window across a tab switch away and back',
    (WidgetTester tester) async {
      ...
      // shell/chart regimes.
      ScrollableState chartScrollState() => tester.state<ScrollableState>(
        find.descendant(
          of: _chartScrollView(),
      ...
      expect(
        chartScrollState().position.pixels,
        offsetBefore,
