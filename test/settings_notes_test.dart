...
void main() {
  testWidgets(
      ...
      'the default hint on the temperature-range card', (tester) async {
    ...
    expect(find.textContaining("the app's local storage"), findsNothing,
        reason: 'the superfluous "settings are stored" note is gone — '
            'users expect settings to persist');
    expect(find.textContaining('restored on the next app start'), findsNothing,
