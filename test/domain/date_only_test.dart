...
void main() {
  group('DateOnly.isWeekend', () {
    ...
    test('marks Saturday and Sunday, spans other weekdays correctly', () {
      expect(DateOnly.isWeekend(DateTime(2026, 9, 4)), isFalse,
          reason: 'Friday');
      expect(DateOnly.isWeekend(DateTime(2026, 9, 5)), isTrue,
          reason: 'Saturday');
      expect(DateOnly.isWeekend(DateTime(2026, 9, 6)), isTrue,
          reason: 'Sunday');
      expect(DateOnly.isWeekend(DateTime(2026, 9, 7)), isFalse,
          reason: 'Monday');
    });
    ...
    test('is calendar-date based: normalization cannot shift the weekday', () {
      ...
      final saturdayLocalLate =
          DateTime(2026, 9, 5, 13, 37); // September afternoon, same day
      expect(
